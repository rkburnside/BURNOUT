...
//#include <SD.h>  <-- NOT NEEDED SINCE THE SD CARD ID DISABLED

/*SD card setup  <-- DISABLED FOR NOW
//#define MISO 50 <--> 12
//#define MOSI 51 <--> 11
//#define CLK 52 <--> 13
#define CS 53	//53 <--> 10
...
#define SELECT 33			//pin # for Select
...
/*motor speed definition -- NOT YET ADDED --
...
String dataString = "";
//String dataString_long = "";	-- THIS IS USED FOR HOLDING MULTIPLE STRINGS TO WRITE TO THE SD CARD...NOT USED ANYMORE
unsigned long sd_time = 0;					// CHANGE THIS SINCE THE SD CARD IS NOT USED ANYMORE
...
/*SD Card Setup -- REMOVED FOR NOW --
	SD.begin(CS);
	dataString = "Millis,Time,GPS Speed,IR Dist,US Dist,Gyro Heading,Course,Lat,Lon,WP Lat,WP Lon,WP Dist,WP Heading,Failed";
...
/*SD CARD STRING CREATION AND WRTITING -- REMOVED FOR NOW --

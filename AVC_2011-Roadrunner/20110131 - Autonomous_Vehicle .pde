...
/*struct waypoint_structure {   //this defines a type of structure that could hold waypoint data
long x;
long y;
double angle;
int time;
...
struct waypoint_structure home, waypoint[3];  //This actually declares some structure variables (home, waypoint[0], waypoint[1], etc).

// examples of how to use it:
my_x = home.x;
someangle = waypoint[2].angle;*/
...
//#define SERVO_MANUAL 4		//pin # for switching to manual
//#define SERVO_AUTO 3		//pin # for switching to autonomous
...
//GPS Waypoints			0-start		1-corner 1		2-corner 2		3-corner 3		4-corner 4		5-finish
...
int waypoint_num = 0;
//39.538576,-105.016975

/* LAT/LON SET: SPARKFUN PARKING LOT
//GPS Waypoints		0-start		1-corner 1	2-corner 2	3-corner 3	4-corner 4	5-finish
int lat_array[5] = {40065155,	40065160,	40064462,	400644720,	400651600,	400651550};
int lon_array[5] = {-10521007,	-105209732,	-105209743,	-105210435,	-105210413,	-105210116};
*/

void setup()
{
	autonomous = false;		//car default state is manual mode, not autonomous mode
	pinMode(RECEIVER_IN, INPUT);
//	pinMode(SERVO_MANUAL, OUTPUT);
//	pinMode(SERVO_AUTO, OUTPUT);
...
void auto_control(void)
{
	...
	{
		autonomous = true;
//		digitalWrite(SERVO_AUTO, HIGH);
//		digitalWrite(SERVO_MANUAL, HIGH);
	}
	else
	{
		autonomous = false;
//		digitalWrite(SERVO_AUTO, LOW);
//		digitalWrite(SERVO_MANUAL, LOW);
	}
	return;
}

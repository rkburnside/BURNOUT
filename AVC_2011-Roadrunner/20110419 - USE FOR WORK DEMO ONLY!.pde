...
const int waypoint_total = 7;	// <- should always be the same number of GPS waypoints
double gps_array[7][2] = {{39.64625554553962, -105.08055895510579},
...
//	if((waypoint_num == special_waypoint_num) && (gps_array[special_waypoint_num+1][0] > flat)) waypoint_num = waypoint_num + 2; // 2 increments are needed to advance correctly

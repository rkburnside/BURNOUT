...
#define THROTTLE xx			//pin # for throttle
...
void compass(void) {
	...
	x = -(xParam - COMP_X);
	y = (yParam - COMP_Y);
//	northFi = -(atan2(y,x) - NORTH);		//this is how a compass works correctly, but we need it to work like a regular graph
//	compass_heading = (northFi * 180.0) / M_PI-81.0 - 90.0;  // 9 is to account for magnetic north
	northFi = atan2(y,x);

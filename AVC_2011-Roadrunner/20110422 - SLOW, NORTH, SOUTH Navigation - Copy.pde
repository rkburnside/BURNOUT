...
double gps_array[15][3] = {{40.065199508645286, -105.20982731314206, 0}, // 1st corner
{40.065136900410714, -105.209752812302, 1}, // 1st line up point
{40.065066081190785, -105.2097529401257, 1}, // 2nd line up point or start of straight line
{40.06490, -105.20975, 1}, // just added today, use this lat also!
{40.064555, -105.2097763511701, 1}, // lat point for start of turn
...
{40.06450670940305, -105.21046836109664, 0}, // 3rd corner
...
void set_speed(void) {	// test this and delete the delays after it works
		...
		if(waypoint_distance > 20)		speed.write(113);
	return;
}
